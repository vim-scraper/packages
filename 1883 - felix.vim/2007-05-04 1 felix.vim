...
syn keyword felixStatement cclass
...
syn keyword felixStatement cparse
...
syn keyword felixStatement obj
...
syn keyword felixStatement parse
syn keyword felixStatement regexp
syn keyword felixStatement reglex
syn keyword felixStatement regmatch
...
syn keyword felixStatement raise read ref regexp return
syn keyword felixStatement struct
...
syn region felixString          start=+\(^\|[^0-9A-Za-z_']\)\@<=[uU]\='+ end=+'+ skip=+\\\\\|\\'+ contains=felixEscape
syn region felixString          start=+\(^\|[^0-9A-Za-z_"]\)\@<=[uU]\="+ end=+"+ skip=+\\\\\|\\"+ contains=felixEscape
syn region felixString          start=+\(^\|[^0-9A-Za-z_"]\)\@<=[uU]\="""+ end=+"""+ contains=felixEscape
syn region felixString          start=+\(^\|[^0-9A-Za-z_']\)\@<=[uU]\='''+ end=+'''+ contains=felixEscape

syn region felixRawString       start=+\(^\|[^0-9A-Za-z_']\)\@<=[uU]\=[rR]'+ end=+'+ skip=+\\\\\|\\'+
syn region felixRawString       start=+\(^\|[^0-9A-Za-z_"]\)\@<=[uU]\=[rR]"+ end=+"+ skip=+\\\\\|\\"+
syn region felixRawString       start=+\(^\|[^0-9A-Za-z_"]\)\@<=[uU]\=[rR]"""+ end=+"""+
syn region felixRawString       start=+\(^\|[^0-9A-Za-z_']\)\@<=[uU]\=[rR]'''+ end=+'''+

syn region felixFormatString    start=+\(^\|[^0-9A-Za-z_']\)\@<=[uU]\=[fF]'+ end=+'+ skip=+\\\\\|\\'+
syn region felixFormatString    start=+\(^\|[^0-9A-Za-z_"]\)\@<=[uU]\=[fF]"+ end=+"+ skip=+\\\\\|\\"+
syn region felixFormatString    start=+\(^\|[^0-9A-Za-z_"]\)\@<=[uU]\=[fF]"""+ end=+"""+
syn region felixFormatString    start=+\(^\|[^0-9A-Za-z_']\)\@<=[uU]\=[fF]'''+ end=+'''+
...
if version >= 508 || !exists("did_flx_syn_inits")
  ...
  HiLink felixFormatString      String
