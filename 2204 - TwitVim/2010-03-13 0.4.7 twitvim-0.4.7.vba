...
1. Contents					*TwitVim* *TwitVim-contents*
	...
	3.4. Hide the header in timeline buffer...: |TwitVim-hide-header|
...
3. Installation						*TwitVim-install*
	...
	If you haven't configured twitvim_login, the first TwitVim command
	that needs Twitter authentication will prompt you to log into Twitter.
	This alternative is provided to allow TwitVim use on a public, shared,
	or non-secure system where storing passwords in the vimrc is not
	advisable.

	If you make a mistake when entering your Twitter login information,
	simply run |:SetLoginTwitter| to reenter your Twitter login
	information or use |:ResetLoginTwitter| to remove the login
	information so that the next TwitVim command will prompt you to log in
	again.
...
4.2. Timeline Commands				*TwitVim-timeline-commands*
	...
	This command prompts you for a Twitter username and password, which
	will then be used for subsequent TwitVim commands. This is an
	alternative to configuring |twitvim_login| in your vimrc.

	If you make a mistake when entering your Twitter login information,
	simply rerun |:SetLoginTwitter| to reenter your Twitter login
	information or use |:ResetLoginTwitter| to remove the login
	information so that the next TwitVim command will prompt you to log in
	again.
	...
	This command removes stored Twitter login information. The next
	TwitVim command that needs Twitter authentication will then prompt you
	log in again.
...
4.3. Mappings						*TwitVim-mappings*
	...
	Instead, it sends the current line to the command line so that you can
	repost it as a new tweet and optionally edit it or add your own
	comments.
