...
"	Name:		co.vim
"
"	Usage:  	put it in your plugins dir, and type ;co when you get the
"				urge.
"			
"	Requires:	vim
"		
"	Provides:	command CommentOut
"				mapping ;co that calls command
"		
...
function! s:CommentOut() abort range
	...
	elseif exists("*CommentOut_".type)
		exec a:firstline.",".a:lastline.' call CommentOut_'.type.'()'
		return
	...
	:echo ':'.a:firstline.",".a:lastline.' '.comment
...
let s:comment_html           ='call CommentOut_xml()'
let s:comment_jsp           ='call CommentOut_xml()'
