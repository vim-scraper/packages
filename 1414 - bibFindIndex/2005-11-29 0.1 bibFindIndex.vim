...
if !exists(":BibGotoIndex")
    fun! <SID>BibGotoIndex(text, delta)
        let txt  = a:text
    ...
    command! -nargs=1 BibGotoIndex call <SID>BibGotoIndex(<q-args>, 0)
    command! -nargs=1 BibGotoNextIndex call <SID>BibGotoIndex(<q-args>, 1)
endif
