...
" Version:       0.1
"
" Based on a publicly available previous version; expanded for some
" new tags in CFMX and such.
...
syn keyword cfTagName contained cfqueryparam cfdump cfimport cflog
syn keyword cfTagName contained cflogin cfloginuser cflogout
syn keyword cfTagName contained cfcomponent cffunction cfargument cfreturn cfinvoke cfinvokeargument
syn keyword cfTagName contained cfsavecontent cfproperty
...
syn keyword cfArg contained var list prefix taglib
syn keyword cfArg contained component returnvariable returntype displayname nameconflict
syn keyword cfArg contained extends access description hint
" chart stuff
syn keyword cfArg contained format chartHeight chartWidth scaleFrom scaleTo showXGridlines showYGridlines gridlines seriesPlacement foregroundColor dataBackgroundColor showBorder font fontSize fontBold fontItalic labelFormat xAxisTitle yAxisTitle xAxisType yAxisType sortXAxis show3D xOffset yOffset rotated showLegend tipStyle tipBGColor showMarkers markerSize pieSliceStyle url name
" chartseries & chartdata stuff
syn keyword cfArg contained type query itemColumn valueColumn seriesLabel seriesColor paintStyle markerStyle colorlist item value
