" Vim syntax file
" Language:	JavaScript + ASP.NET Directive
...
syn region  javaScriptAspxComment start=+<%--+ end=+--%>+ extend
syn region  javaScriptAspxCode start=+<% + end=+%>+ extend
syn region  javaScriptAspxCode start=+<%=+ end=+%>+ extend
syn region  javaScriptAspxDirective start=+^<%@+ end=+%>$+ contains=javaScriptAspxAttrib,javaScriptStringD,javaScriptStringS
syn match  javaScriptAspxAttrib "\w\+="
...
syn keyword javaScriptSpecial          thiz
...
if version >= 508 || !exists("did_javascript_syn_inits")
  ...
  HiLink javaScriptAspxAttrib        Identifier
  HiLink javaScriptAspxDirective     Special
  HiLink javaScriptAspxCode	     PreProc
  HiLink javaScriptAspxComment	     Comment
