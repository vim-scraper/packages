...
hi Directory	    guibg=#F1FFC1 guifg=DarkGray gui=bold,italic 
hi Tooltip   	    guibg=#F1FFC1 guifg=DarkGray gui=bold,italic 
hi FoldColumn       guibg=#F1FFC1 guifg=Black gui=none 
hi VertSplit        guibg=DimGray guifg=White gui=none 
...
hi Underlined		guibg=#f0f0f0 guifg=#0057ae gui=underline
...
hi Macro			guibg=white guifg=black gui=NONE
...
"
" int char conflict
hi Type		        guibg=white guifg=#0057ae gui=NONE 
