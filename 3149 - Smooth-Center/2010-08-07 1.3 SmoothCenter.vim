...
" |                       value, not just the cursors position within the       |
" |                      current window.  Changed key mappings to be a more "   |
" |                      natural-feeling S-ESC gets you 'out of the code', in   |
" |                      other words lets you see where you are by scrolling the|
" |                      file down, whereas S-F1 scrolls up and hence further   |
" |                      deep into the file.                                    |
...
map <S-F1> :call StartSmoothCentering(2)<CR>
map <S-Esc> :call StartSmoothCentering(3)<CR>
...
:	endif
:	let changeflag = 0
:	if line(".")>centerline+eval("&scrolloff")
:		let changeflag = 1 
:	endif
:	if line(".")<centerline-eval("&scrolloff")
:		let changeflag = 2
