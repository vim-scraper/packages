...
au FileType perl SetCompilerInfo! perl
	    \ title='perl' src='%:.'
	    \ cmd="#RUN_DIRECT"
	    \ run="perl $flags -- $src $args" args=''
	    \ flags='-w' debug_flags='-wd'
...
au FileType python SetCompilerInfo! python
	    \ title='Python' src='%:.'
	    \ cmd="#RUN_DIRECT"
	    \ run="python $flags $src $args" args=''
	    \ flags='-OO' debug_flags='-d'

" filetype ruby {{{1

au FileType ruby SetExtensionName rb
au FileType ruby SetCompilerInfo! ruby
	    \ title='Ruby 1.9.1 - Matz' src='%:.'
	    \ cmd='#RUN_DIRECT'
	    \ run='ruby $flags -- $src $args' args=''
	    \ flags='-w' debug_flags='-rdebug $flags'
