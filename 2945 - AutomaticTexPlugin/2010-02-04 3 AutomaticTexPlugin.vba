...
map t
	...
	window in which you can use the mappings: 
		...
		'c' 	to copy the label of the chapter under the curosor
		...
		<Enter> to go to the chapter under the cursor.
...
highlight atp_chaptertitle

highlight atp_section
highlight atp_sectiontitle

highlight atp_subsection
highlight atp_subsectiontitle

highlight atp_abstract
	*this group highlights all the unnubered chapters.
...
>
 "    bibsearchInfo
<
which highlights the line number of the bib entry in the bib file. 
All bibsearch groups are by default linked to the bib groups.

Yet, there is no default highlighting, try coots-beauty-256 color scheme. If
you like it, I'm glad, if you have a nice (non standard) color scheme, I'm
happy to get it, if you like to share it.
