...
2580
automatic-tex-plugin.txt 	For Vim version 7	Last change: 2010 August 8
...
:FindInputFiles [bufname]
	...
	bufername.
							...
							*atp-:GotoFile*
:GotoFile
:EditInputFile	/ the old name for this feature / 
...
let b:atp_MainFile	= expand("%:p")
	...
	startup to the file you open. If you edit project file, start with the
...
here (my email you'll find usging gg). Here are two which I found recently: 
...
:TeXdoc ams<Ctrl-d>		Show tex documention which matches ams (the
