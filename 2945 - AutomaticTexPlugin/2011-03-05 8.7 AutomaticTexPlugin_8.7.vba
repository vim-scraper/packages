...
3765
*automatic-tex-plugin.txt* 	For Vim version 7	Last change: 5 March 2011

			An Introduction to AUTOMATIC (La)TeX PLUGIN (ver 8.7)
...
<
  							*atp-:WordCount*
  - Added completion support for packeges: BEAMER, MATHTOOLS.
...
<
  ...
  - a fix in project file writting function (thanks to a user bug report).
