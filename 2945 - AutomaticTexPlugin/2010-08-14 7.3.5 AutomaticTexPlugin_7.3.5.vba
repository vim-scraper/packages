...
2828
automatic-tex-plugin.txt 	For Vim version 7	Last change: 2010 August 14
...
<	which do the obvious thing (unless g:atp_nohistory = 1). DeleteHistory
	command deletes all entries of history variables for the current file,
	with bang "!" it deletes the whole history file.
