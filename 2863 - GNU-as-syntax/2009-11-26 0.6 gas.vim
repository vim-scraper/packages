...
syn keyword gasRegisterX86	%eax %ebx %ecx %edx %ax %bx %cx %db %ah %al %bh %bl %ch %cl %dh %dl
...
syn keyword gasOpcode_386_Base		popfd
...
syn keyword gasOpcode_386_Base		stosd
...
syn match   gasOpcode_8086_Base		/\<j\(e\|ne\|ae\|be\|z\|nz\|c\|nc\|d\|nd\)[bwlq]\?\>/
syn match   gasOpcode_386_Base		/\<set\(e\|ne\|ae\|be\|z\|nz\|c\|nc\|d\|nd\)\>/
