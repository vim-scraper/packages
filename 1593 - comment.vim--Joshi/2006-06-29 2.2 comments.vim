...
" Last Change : 30th Jun, 2006
" Original By : Jasmeet Singh Anand <jasanand@hotmail.com>
" Appended by : Keyur Joshi<keyurjoshi@gmail.com>
" Change done : Added commenting-uncommenting for .tex and .bib files 
" Version     : 2.2
" Usage       : For VIM 6 -
...
function! CommentLine()
  ...
  if file_name =~ '\.cpp$' || file_name =~ '\.hpp$' || file_name =~ '\.java$' || file_name =~ '\.php[23]\?$'
  ...
  elseif file_name =~ '\.vim$' || file_name =~ '\.vimrc$'
	 execute ":silent! normal ^i\"\<ESC>\<down>^"
"""""""""""""""""""""""""""""""""""""""""""""""""""""""
""""""""   Appended by Keyur Joshi"""""""""""""""""""""
"""""""""""""""""""""""""""""""""""""""""""""""""""""""
  " for .tex or .bib files use %
  elseif file_name =~ '\.tex$' || file_name =~ '\.bib$'
	 execute ":silent! normal ^i\%\<ESC>\<down>^"
"""""""""""""""""""""""""""""""""""""""""""""""""""""""
  " for .sql files use --
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""
  " for .tex or .bib  files use %
  elseif file_name =~ '\.tex$' || file_name =~ '\.bib$'
    execute ":silent! normal :nohlsearch\<CR>:s/%/\<CR>\<down>:nohlsearch\<CR>"
"""""""""""""""""""""""""""""""""""""""""""""""""""""""
  " for .sql files use --
  elseif file_name =~ '\.sql$'
    execute ":silent! normal :nohlsearch\<CR>:s/\\-\\-//\<CR>:nohlsearch\<CR>"
