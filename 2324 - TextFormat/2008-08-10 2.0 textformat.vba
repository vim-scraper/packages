...
298
*textformat.txt*        Vim Text Formatter  (version 2.0)           2008-08-10
...
operate on the selected lines. By default, <Leader> is the backslash key so by 
default the mappings are actually \al, \ar, \aj and \ac. If you have changed 
the g:mapleader variable in your .vimrc file <Leader> may be something else.
...
<Leader>ac              Center lines of current "inner paragraph" (see |ip|) 
                        ...
                        line. Reformatting would make it difficult.
...
"w" then new paragraph also begins after each line which ends with 
...
loading this plugin put the following line in your .vimrc file: >
