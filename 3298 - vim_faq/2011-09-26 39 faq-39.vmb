...
"
" Script: 
" GetLatestVimScripts: 3298 39 :AutoInstall: faq_plugin.vim
"
"
...
|faq-36.11| Why shouldn't I modify the files in the system runtime
	  directory?
|faq-36.12| How Du I debug and find out if there is an error in my .vimrc
	  or in any other file that is read during startup?
                                                                *faq-unicode*
SECTION 37 - UNICODE
...
online version at http://vimhelp.appspot.com
 								*faq-2.5*
...
http://code.google.com/p/vim/issues/list. A copy of each message there
...
(it is configurable, what is considered to be a large file, be default,
it is 100MB).
...
This means, it matches as
few as possible 'a's whithout trying to keep going until Vim finds the
longest match. This means, it will still match 'ap'.
...
be found at http://groups.google.com/group/vim_dev/msg/75f1f2dfc00908bb
...
The matchit plugin provides a similar function, that let's the cursor
...
they will not be overwritten.
 								...
 								*faq-36.12*
36.12. How Du I debug and find out if there is an error in my .vimrc or
       in any other file that is read during startup?
...
simple side effect of any configuration option from your .vimrc. So
...
reading .vimrc file and -U NONE for not reading a .gvimrc file).

If the error persists, the chance is good you've found a bug in Vim (see
also Question 2.6. |faq-2.6|

If the error does not occur when starting Vim this way, you need to find
out, what triggers the error, you try starting Vim this way: >
