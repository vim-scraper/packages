" Interactive Data Language syntax file
" Maintainer: Hayato MIKAMI <hayato.mikami AT gmail.com>
...
syn match idlangRoutine "CW_\a*"
syn match idlangRoutine "DICOMEX_\a*"
syn match idlangRoutine "FILE_\a*"
syn match idlangRoutine "GUIB_\a*"
syn match idlangRoutine "H5\a*"
syn match idlangRoutine "HANDLE_\a*"
syn match idlangRoutine "ION_\a*"
syn match idlangRoutine "ITOOL_\a*"
syn match idlangRoutine "IT_\a*"
syn match idlangRoutine "LA_\a*"
syn match idlangRoutine "LOGICAL_\a*"
syn match idlangRoutine "MAP_\a*"
syn match idlangRoutine "PREF_\a*"
syn match idlangRoutine "SEM_\a*"
syn match idlangRoutine "WIDGET_\a*"
...
syn keyword idlangRoutine CURSOR CURVEFIT CV_COORD CVTTOBM DBLARR
...
syn keyword idlangRoutine F_PDF FACTORIAL FFT 
...
syn keyword idlangRoutine M_CORRELATE MACHAR MAKE_ARRAY MAKE_DLL
syn keyword idlangRoutine MATRIX_MULTIPLY MD_TEST MEAN
...
syn keyword idlangRoutine WEOF WF_DRAW WHERE WINDOW
...
syn keyword idlangRoutine APP_USER_DIR APP_USER_DIR_QUERY ARRAY_INDICES
syn keyword idlangRoutine BIT_FFS BIT_POPULATION BUTTERWORTH CANNY CASE
syn keyword idlangRoutine CMYK_CONVERT COMMAND_LINE_ARGS COMPILE_OPT
syn keyword idlangRoutine CONTINUE COPY_LUN CPU DB_EXISTS DEFINE_MSGBLK
syn keyword idlangRoutine DEFINE_MSGBLK_FROM_FILE DEMO_MODE DENDROGRAM
syn keyword idlangRoutine DIAG_MATRIX EDITOR_PREFS ERF ERFC ERFCX EVENTS
syn keyword idlangRoutine EVENT_DECL FONT_PREFS GENERAL_PREFS
syn keyword idlangRoutine GRAPHICS_PREFS GRIDDATA GRID_INPUT HEAP_FREE
syn keyword idlangRoutine IDL IDLITSYS_CREATETOOL IDLITSYS_CREATE_TOOL
syn keyword idlangRoutine IDL_VALIDNAME IIMAGE IIMAGE_OPS IMAP INPUT
syn keyword idlangRoutine INP_INPW_OUTP_OUTPW INTERVAL_VOLUME IR_FILTER
syn keyword idlangRoutine ITCURRENT ITDELETE ITGETCURRENT ITREGISTER
syn keyword idlangRoutine ITRESET ITRESOLVE IVECTOR IVOLUME IX
syn keyword idlangRoutine LAYOUT_PREFS LM_FIT MATRIX_POWER PATH_CACHE
syn keyword idlangRoutine PATH_PREFS PATH_SEP PICKFILE PRO PRODUCT
syn keyword idlangRoutine QHULL REAL_PART REGION_GROW RIEMANN
syn keyword idlangRoutine SCOPE_VARFETCH SCOPE_VARNAME SHMDEBUG SHMMAP
syn keyword idlangRoutine SHMUNMAP SHMVAR SIMPLEX SKIP_LUN SLICER
