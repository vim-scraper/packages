...
UseVimball
finish
after/ftplugin/actionscript_snippets.vim	[[[1
9
...
after/ftplugin/asp_snippets.vim	[[[1
17
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/c_snippets.vim	[[[1
51
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/css_snippets.vim	[[[1
30
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/django_model_snippets.vim	[[[1
61
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/django_template_snippets.vim	[[[1
32
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/f-script_snippets.vim	[[[1
14
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/haskell_snippets.vim	[[[1
9
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/html_snippets.vim	[[[1
57
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/java_snippets.vim	[[[1
52
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/javascript_snippets.vim	[[[1
10
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/latex_snippets.vim	[[[1
13
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/logo_snippets.vim	[[[1
9
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/markdown_snippets.vim	[[[1
10
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/movable_type_snippets.vim	[[[1
14
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/objc_snippets.vim	[[[1
53
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/ocaml_snippets.vim	[[[1
26
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/perl_snippets.vim	[[[1
23
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/php_snippets.vim	[[[1
30
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/phpdoc_snippets.vim	[[[1
19
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/propel_snippets.vim	[[[1
14
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/python_snippets.vim	[[[1
202
if !exists('loaded_snippet') || &cp
    finish
endif
...
\<CR>def runTest(self):
\<CR>".st.et
after/ftplugin/rails_snippets.vim	[[[1
54
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/ruby_snippets.vim	[[[1
32
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/sh_snippets.vim	[[[1
12
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/slate_snippets.vim	[[[1
19
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/smarty_snippets.vim	[[[1
35
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/symfony_snippets.vim	[[[1
21
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/tcl_snippets.vim	[[[1
14
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/template_toolkit_snippets.vim	[[[1
13
if !exists('loaded_snippet') || &cp
    finish
endif
...
after/ftplugin/tex_snippets.vim	[[[1
13
if !exists('loaded_snippet') || &cp
    finish
endif
...
exec "Snippet itd \\item[".st."desc".et."] ".st.et
exec "Snippet sec \\section{".st."name".et."}\\label{sec:".st."name:substitute(@z,'.','\\l&','g')".et."<CR>".st.et
after/ftplugin/xhtml_snippets.vim	[[[1
48
if !exists('loaded_snippet') || &cp
    finish
endif
